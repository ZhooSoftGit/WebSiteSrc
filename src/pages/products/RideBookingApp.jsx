...
const RideBookingApp = () => {
  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      ...
      >
        <h1 className="text-4xl font-bold mb-4 text-center text-blue-700">Ride Booking App (like Uber)</h1>
        ...
        <div className="mt-16 bg-gray-100 p-8 rounded-lg shadow-md">
          <h2 className="text-3xl font-bold mb-6 text-center text-blue-600">Why Choose Our Ride Booking Solution?</h2>
