  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex justify-center w-1/12">
        <div className="w-1 h-full bg-teal-300 rounded-t-full rounded-b-full"></div>
      </div>
      <div className="w-full md:w-5/12">
        <div className={`bg-white p-6 rounded-xl shadow-xl border border-gray-200 ${alignLeft ? "md:text-right" : "md:text-left"}`}>
          <div className={`flex items-center ${alignLeft ? "md:flex-row-reverse" : ""} mb-2`}>
            <div className={`p-2 bg-teal-100 text-teal-600 rounded-full ${alignLeft ? "md:ml-3" : "md:mr-3"}`}>
              {icon}
            </div>
            <h3 className="text-2xl font-bold text-teal-700">{year}</h3>
          </div>
  ...
  return (
    <div className="pt-20 md:pt-24 pb-16 bg-gray-50">
      <header className="py-12 md:py-16 bg-gradient-to-r from-teal-600 to-cyan-700 text-white text-center">
        ...
        >
          <CalendarDays className="h-16 w-16 mx-auto mb-4 text-teal-300" />
      ...
      <div className="container mx-auto px-4 md:px-6 py-16">
        <div className="relative wrap overflow-hidden p-2 md:p-10 h-full">
          <div className="hidden md:block border-2-2 absolute border-opacity-20 border-teal-700 h-full border" style={{left: "50%"}}></div>
