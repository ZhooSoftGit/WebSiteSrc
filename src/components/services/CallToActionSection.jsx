...
const CallToActionSection = ({ 
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-teal-700 to-cyan-800 text-white">
      <div className="container mx-auto px-4 md:px-6">
        <motion.div 
          ...
          variants={fadeIn}
        >
          <Phone className="h-12 w-12 md:h-16 md:w-16 mx-auto mb-6 text-teal-300"/>
